  ...
  return (
    <>
      <div className='gmail-container'>
        ...
        <header className='email-header border-bottom'>
          ...
          <div className='d-flex align-items-center'>
            ...
            <div className='profile-icon rounded-circle bg-danger text-white align-items-center justify-content-center'
              style={{
                width: "32px",
                height: "32px",
                fontSize: "18px",
            ...
            <div className='col-md-9 main-content'>
              <div className='email-list'>
                <div className='email-row d-flex align-items-center border-bottom'>
                   <Form.Check types="checkbox" className="email-checkbox py-2"/>
                   <button variant="link" className="star-btn p-0 btn py-2">


                   </button>
                   <span className="sender py-2">Google </span>
                   <span className="subject flex-grow-1 py-2">
                    welcome to Gmail{" "}
                    <span className="snippet py-2">
